"""
Attempt 2 at MPI implementation, limited to MC_step
"""
...
def MC_step(arr,Ts,nmax):
    ...
    #print(f"[Rank {rank}] Processing indices from {start_idx} to {end_idx}")
    ...
    if rank == 0:
        ...
        #print(f"[Rank 0] Total acceptance ratio: {total_ratio}")
        return total_ratio
    else:
        return None  # Non-zero ranks don't need to return anything
#=======================================================================
def main(program, nsteps, nmax, temp, pflag):
    ...
    # Plot initial frame of lattice on rank 0
